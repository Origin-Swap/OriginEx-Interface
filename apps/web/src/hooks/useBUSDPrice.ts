...
import { USDT, ORIX, USDC } from '@pancakeswap/tokens'
...
export const useCakeBusdPrice = (
  ...
  const cake: Token = isTestnet ? ORIX[ChainId.BSC] : ORIX[ChainId.VANAR_TESTNET]
...
export const useBNBBusdPrice = (
  ...
  const wbnb: Token = isTestnet ? WBNB[ChainId.BSC] : WBNB[ChainId.VANAR_TESTNET]
