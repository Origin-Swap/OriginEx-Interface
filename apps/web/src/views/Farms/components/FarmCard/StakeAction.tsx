...
const StakeAction: React.FC<React.PropsWithChildren<FarmCardActionsProps>> = ({
  ...
  const crossChainWarningText = useMemo(() => {
    return isFirstTime
      ? t('A small amount of %nativeToken% is required for the first-time setup of cross-chain ORIX farming.', {
  ...
  const [onPresentDeposit] = useModal(
    <FarmUI.DepositModal
      ...
      showCrossChainFarmWarning={chainId !== ChainId.BSC && chainId !== ChainId.VANAR_TESTNET}
