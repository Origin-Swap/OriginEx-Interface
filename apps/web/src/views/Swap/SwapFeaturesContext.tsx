...
const CHART_SUPPORT_CHAIN_IDS = [ChainId.VANAR_TESTNET]
const ACCESS_TOKEN_SUPPORT_CHAIN_IDS = [ChainId.VANAR_TESTNET]
const STABLE_SUPPORT_CHAIN_IDS = [ChainId.VANAR_TESTNET]
